  ...
  return (
    <MarketingPage
      ...
      stats={[
        ...
        { value: "JWT", label: "Required auth secret", tone: "violet" },
      ]}
      sidePanel={{
        label: "posture",
        ...
        rows: [
          { label: "Auth", value: "GO_JWT_SECRET or AUTH_JWT_SECRET" },
      ...
      sections={[
        ...
        },
        {
          ...
          body: "Session signing relies on a configured JWT secret. Missing auth secrets should fail early instead of producing predictable tokens.",
          items: ["GO_JWT_SECRET supported", "AUTH_JWT_SECRET supported", "Startup-time configuration checks"],
        },
        {
          icon: EyeOff,
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-16 sm:px-8">
        <div className="rounded-lg border border-slate-800 bg-[#080b0f] p-8">
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-2">
            {["Set GO_JWT_SECRET or AUTH_JWT_SECRET before backend startup", "Set PROVIDER_ENCRYPTION_KEY to exactly 32 bytes", "Use HTTPS in front of API and client surfaces", "Keep volume passphrase recovery expectations clear"].map((item) => (
