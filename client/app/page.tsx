    ...
    <main className="min-h-screen bg-[#050708] text-slate-200">
      ...
      <header className="sticky top-0 z-30 border-b border-emerald-400/10 bg-[#050708]/90 backdrop-blur">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <div className="hidden items-center gap-7 text-xs uppercase tracking-[0.18em] text-slate-400 md:flex">
            <a href="#pipeline" className="hover:text-emerald-300">Pipeline</a>
            <a href="#features" className="hover:text-emerald-300">Features</a>
            <a href="#security" className="hover:text-emerald-300">Security</a>
